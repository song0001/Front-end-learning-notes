...
https://blog.csdn.net/Djj_Alice/article/details/102785841

 `Mixin`对于封装一小段想要复用的代码来讲是有用的，`Mixin`的优点是不需要传递状态，但缺点也显而易见可能会被滥用。
...
教程:https://www.cnblogs.com/wxy0/p/13335399.html

## git 版本学习

https://houdunren.gitee.io/note/git/git.html#%E6%97%A5%E5%BF%97%E6%9F%A5%E7%9C%8B
...
```
git checkout -b origin/develop(远程分支名)
```
